...
import { IonContent, IonPage, IonHeader, IonTitle, IonToolbar, IonCard, IonCardTitle, IonCardSubtitle } from '@ionic/react';
      ...
      <IonContent fullscreen className="ion-padding">
        ...
        <div className="product-list">
          ...
          <IonCard key={product.id} routerLink={`/shop/${product.id}`} routerDirection="forward">
            <img alt={product.title} decoding="async" src={`/images/${product.image}`} />
